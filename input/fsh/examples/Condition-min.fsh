...
* category = https://twcore.mohw.gov.tw/ig/ci/CodeSystem/nhi-category#1
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
	...
	<p>
		<b>重大傷病類別</b>：癌症 <span style=\"background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki\"> (<a href=\"ValueSet-nhi-category.html/\">ConditionClinicalStatusCodes </a>#1)</span>
	</p>
