...
* patient.mobile 1..1 string "手機號碼" "手機號碼"
* patient.contactTel 1..1 string "連絡電話" "連絡電話"
* patient.email 0..1 string "電子郵件信箱" "電子郵件信箱"

// 醫師資訊
* doctor 1..1 BackboneElement "醫師資訊" "醫師資訊"
* doctor.diagPrsnId 1..1 string "醫師身分證字號" "醫師身分證字號"
...
* illness.cancerTreatment 1..* CodeableConcept "後續治療評估" "後續治療評估"